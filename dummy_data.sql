...
INSERT INTO users (username, password, user_role, name, email, phone_number, city, authentication_method)
VALUES ('ali123', 'hashed_password_1', 'USER', 'Ali Rezaei', 'ali.rezaei@email.com', '09121112233', 1, 'EMAIL'),
       ('sara456', 'hashed_password_2', 'USER', 'Sara Ahmadi', 'sara.ahmadi@email.com', '09134445566', 5,
        'PHONE_NUMBER'),
       ('mohammad789', 'hashed_password_3', 'USER', 'Mohammad Hosseini', 'mohammad.hosseini@email.com', '09157778899',
        7, 'EMAIL'),
       ('zahra101', 'hashed_password_4', 'USER', 'Zahra Karimzadeh', 'zahra.karimzadeh@email.com', '09160001122', 8,
        'EMAIL'),
       ('reza202', 'hashed_password_5', 'USER', 'Reza Mohammadi', 'reza.mohammadi@email.com', '09173334455', 9,
        'PHONE_NUMBER'),
       ('leila303', 'hashed_password_6', 'USER', 'Leila Hosseinzadeh', 'leila.hosseinzadeh@email.com', '09186667788', 6,
        'EMAIL'),
       ('hassan404', 'hashed_password_7', 'USER', 'Hassan Ebrahimi', 'hassan.ebrahimi@email.com', '09199990011', 10,
        'PHONE_NUMBER'),
       ('nazanin505', 'hashed_password_8', 'USER', 'Nazanin Rahimi', 'nazanin.rahimi@email.com', '09112223344', 11,
        'EMAIL'),
       ('amir606', 'hashed_password_9', 'USER', 'Amir Hosseini', 'amir.hosseini@email.com', '09125556677', 12,
        'PHONE_NUMBER'),
       ('fateme707', 'hashed_password_10', 'USER', 'Fateme Ghasemi', 'fateme.ghasemi@email.com', '09138889900', 13,
        'EMAIL'),
       ('ahmad808', 'hashed_password_11', 'USER', 'Ahmad Rezaei', 'ahmad.rezaei@email.com', '09141112234', 14,
        'PHONE_NUMBER'),
       ('mahsa909', 'hashed_password_12', 'USER', 'Mahsa Ahmadi', 'mahsa.ahmadi@email.com', '09154445567', 15, 'EMAIL'),
       ('kaveh1010', 'hashed_password_13', 'USER', 'Kaveh Hosseini', 'kaveh.hosseini@email.com', '09167778890', 16,
        'PHONE_NUMBER'),
       ('sima1111', 'hashed_password_14', 'USER', 'Sima Karimzadeh', 'sima.karimzadeh@email.com', '09170001123', 17,
        'EMAIL'),
       ('behnam1212', 'hashed_password_15', 'USER', 'Behnam Mohammadi', 'behnam.mohammadi@email.com', '09183334456', 18,
        'PHONE_NUMBER'),
       ('parisa1313', 'hashed_password_16', 'USER', 'Parisa Hosseinzadeh', 'parisa.hosseinzadeh@email.com',
        '09196667789', 19, 'EMAIL'),
       ('kamran1414', 'hashed_password_17', 'USER', 'Kamran Ebrahimi', 'kamran.ebrahimi@email.com', '09199990012', 20,
        'PHONE_NUMBER'),
       ('niloofar1515', 'hashed_password_18', 'USER', 'Niloofar Rahimi', 'niloofar.rahimi@email.com', '09112223345', 1,
        'EMAIL'),
       ('arash1616', 'hashed_password_19', 'USER', 'Arash Hosseini', 'arash.hosseini@email.com', '09125556678', 5,
        'PHONE_NUMBER'),
       ('shirin1717', 'hashed_password_20', 'USER', 'Shirin Ghasemi', 'shirin.ghasemi@email.com', '09138889901', 6,
        'EMAIL'),
       ...
       ('user1818', 'hashed_password_23', 'USER', 'Ali Asghar', 'ali.asghar@email.com', '09167778891', 7,
        'PHONE_NUMBER'),
       ('user1919', 'hashed_password_24', 'USER', 'Maryam Jafari', 'maryam.jafari@email.com', '09170001124', 8,
        'EMAIL'),
       ('user2020', 'hashed_password_25', 'USER', 'Hossein Kazemi', 'hossein.kazemi@email.com', '09183334457', 9,
        'PHONE_NUMBER'),
       ('user2121', 'hashed_password_26', 'USER', 'Fatemeh Rahimi', 'fatemeh.rahimi@email.com', '09196667790', 10,
        'EMAIL'),
       ('user2222', 'hashed_password_27', 'USER', 'Reza Ahmadi', 'reza.ahmadi@email.com', '09199990013', 11,
        'PHONE_NUMBER'),
       ('user2323', 'hashed_password_28', 'USER', 'Sara Hosseini', 'sara.hosseini@email.com', '09112223346', 12,
        'EMAIL'),
       ('user2424', 'hashed_password_29', 'USER', 'Mohsen Ghasemi', 'mohsen.ghasemi@email.com', '09125556679', 13,
        'PHONE_NUMBER'),
       ('user2525', 'hashed_password_30', 'USER', 'Zahra Rezaei', 'zahra.rezaei@email.com', '09138889902', 14, 'EMAIL'),
       ('user2626', 'hashed_password_31', 'USER', 'Ali Mohammadi', 'ali.mohammadi@email.com', '09141112236', 15,
        'PHONE_NUMBER'),
       ('user2727', 'hashed_password_32', 'USER', 'Leila Karimzadeh', 'leila.karimzadeh@email.com', '09154445569', 16,
        'EMAIL'),
       ('user2828', 'hashed_password_33', 'USER', 'Hassan Ahmadi', 'hassan.ahmadi@email.com', '09167778892', 17,
        'PHONE_NUMBER'),
       ('user2929', 'hashed_password_34', 'USER', 'Nazanin Hosseini', 'nazanin.hosseini@email.com', '09170001125', 18,
        'PHONE_NUMBER'),
       ('user3030', 'hashed_password_35', 'USER', 'Amir Rezaei', 'amir.rezaei@email.com', '09183334458', 19, 'EMAIL'),
       ('user3131', 'hashed_password_36', 'USER', 'Fateme Mohammadi', 'fateme.mohammadi@email.com', '09196667791', 20,
        'PHONE_NUMBER'),
       ('user3232', 'hashed_password_37', 'USER', 'Ahmad Karimzadeh', 'ahmad.karimzadeh@email.com', '09199990014', 1,
        'EMAIL'),
       ('user3333', 'hashed_password_38', 'USER', 'Mahsa Hosseini', 'mahsa.hosseini@email.com', '09112223347', 5,
        'PHONE_NUMBER'),
       ('user3434', 'hashed_password_39', 'USER', 'Kaveh Ahmadi', 'kaveh.ahmadi@email.com', '09125556680', 6, 'EMAIL'),
       ('user3535', 'hashed_password_40', 'USER', 'Sima Rezaei', 'sima.rezaei@email.com', '09138889903', 7,
        'PHONE_NUMBER'),
       ('user3636', 'hashed_password_41', 'USER', 'Behnam Mohammadi', 'behnam.mohammadi2@email.com', '09141112237', 8,
        'PHONE_NUMBER'),
       ('user3737', 'hashed_password_42', 'USER', 'Parisa Karimzadeh', 'parisa.karimzadeh@email.com', '09154445570', 9,
        'EMAIL'),
       ('user3838', 'hashed_password_43', 'USER', 'Kamran Ahmadi', 'kamran.ahmadi@email.com', '09167778893', 10,
        'PHONE_NUMBER'),
       ('user3939', 'hashed_password_44', 'USER', 'Niloofar Hosseini', 'niloofar.hosseini@email.com', '09170001126', 11,
        'PHONE_NUMBER'),
       ('user4040', 'hashed_password_45', 'USER', 'Arash Rezaei', 'arash.rezaei@email.com', '09183334459', 12,
        'PHONE_NUMBER'),
       ('user4141', 'hashed_password_46', 'USER', 'Shirin Mohammadi', 'shirin.mohammadi@email.com', '09196667792', 13,
        'PHONE_NUMBER'),
       ('user4242', 'hashed_password_47', 'USER', 'Ali Karimzadeh', 'ali.karimzadeh@email.com', '09199990015', 14,
        'PHONE_NUMBER'),
       ('user4343', 'hashed_password_48', 'USER', 'Leila Ahmadi', 'leila.ahmadi@email.com', '09112223348', 15,
        'PHONE_NUMBER'),
       ('user4444', 'hashed_password_49', 'USER', 'Hassan Hosseini', 'hassan.hosseini@email.com', '09125556681', 16,
        'PHONE_NUMBER'),
       ('user4545', 'hashed_password_50', 'USER', 'Nazanin Rezaei', 'nazanin.rezaei@email.com', '09138889904', 17,
        'PHONE_NUMBER'),
       ('user4646', 'hashed_password_51', 'USER', 'Ehsan Mohammadi', 'ehsan.mohammadi@email.com', '09141112238', 18,
        'EMAIL'),
       ('user4747', 'hashed_password_52', 'USER', 'Maryam Karimzadeh', 'maryam.karimzadeh@email.com', '09154445571', 19,
        'PHONE_NUMBER'),
       ('user4848', 'hashed_password_53', 'USER', 'Reza Hosseini', 'reza.hosseini@email.com', '09167778894', 20,
        'EMAIL'),
       ('user4949', 'hashed_password_54', 'USER', 'Sara Ahmadi', 'sara.ahmadi2@email.com', '09170001127', 21,
        'PHONE_NUMBER'),
       ('user5050', 'hashed_password_55', 'USER', 'Ali Rezaei', 'ali.rezaei2@email.com', '09183334460', 22, 'EMAIL'),
       ('user5151', 'hashed_password_56', 'USER', 'Zahra Mohammadi', 'zahra.mohammadi@email.com', '09196667793', 23,
        'PHONE_NUMBER'),
       ('user5252', 'hashed_password_57', 'USER', 'Hassan Karimzadeh', 'hassan.karimzadeh@email.com', '09199990016', 24,
        'EMAIL'),
       ('user5353', 'hashed_password_58', 'USER', 'Leila Hosseini', 'leila.hosseini2@email.com', '09112223349', 25,
        'PHONE_NUMBER'),
       ('user5454', 'hashed_password_59', 'USER', 'Amir Ahmadi', 'amir.ahmadi@email.com', '09125556682', 26, 'EMAIL'),
       ('user5555', 'hashed_password_60', 'USER', 'Fateme Rezaei', 'fateme.rezaei@email.com', '09138889905', 27,
        'PHONE_NUMBER'),
       ('user5656', 'hashed_password_61', 'USER', 'Ahmad Mohammadi', 'ahmad.mohammadi@email.com', '09141112239', 28,
        'EMAIL'),
       ('user5757', 'hashed_password_62', 'USER', 'Mahsa Hosseini', 'mahsa.hosseini2@email.com', '09154445572', 29,
        'PHONE_NUMBER'),
       ('user5858', 'hashed_password_63', 'USER', 'Kaveh Ahmadi', 'kaveh.ahmadi2@email.com', '09167778895', 30,
        'EMAIL'),
       ('user5959', 'hashed_password_64', 'USER', 'Sima Rezaei', 'sima.rezaei2@email.com', '09170001128', 31,
        'PHONE_NUMBER'),
       ('user6060', 'hashed_password_65', 'USER', 'Behnam Karimzadeh', 'behnam.karimzadeh@email.com', '09183334461', 32,
        'EMAIL'),
       ('user6161', 'hashed_password_66', 'USER', 'Parisa Hosseini', 'parisa.hosseini2@email.com', '09196667794', 33,
        'PHONE_NUMBER'),
       ('user6262', 'hashed_password_67', 'USER', 'Kamran Ahmadi', 'kamran.ahmadi2@email.com', '09199990017', 34,
        'EMAIL'),
       ('user6363', 'hashed_password_68', 'USER', 'Niloofar Rezaei', 'niloofar.rezaei2@email.com', '09112223350', 35,
        'PHONE_NUMBER'),
       ('user6464', 'hashed_password_69', 'USER', 'Arash Mohammadi', 'arash.mohammadi@email.com', '09125556683', 36,
        'EMAIL'),
       ('user6565', 'hashed_password_70', 'USER', 'Shirin Karimzadeh', 'shirin.karimzadeh@email.com', '09138889906', 37,
        'PHONE_NUMBER'),
       ('user6666', 'hashed_password_71', 'USER', 'Ali Hosseini', 'ali.hosseini2@email.com', '09141112240', 38,
        'EMAIL'),
       ('user6767', 'hashed_password_72', 'USER', 'Leila Ahmadi', 'leila.ahmadi2@email.com', '09154445573', 39,
        'PHONE_NUMBER'),
       ('user6868', 'hashed_password_73', 'USER', 'Hassan Rezaei', 'hassan.rezaei2@email.com', '09167778896', 40,
        'EMAIL'),
       ('user6969', 'hashed_password_74', 'USER', 'Nazanin Mohammadi', 'nazanin.mohammadi@email.com', '09170001129', 41,
        'PHONE_NUMBER'),
       ('user7070', 'hashed_password_75', 'USER', 'Amir Karimzadeh', 'amir.karimzadeh@email.com', '09183334462', 42,
        'EMAIL'),
       ('user7171', 'hashed_password_76', 'USER', 'Fateme Hosseini', 'fateme.hosseini2@email.com', '09196667795', 43,
        'PHONE_NUMBER'),
       ('user7272', 'hashed_password_77', 'USER', 'Ahmad Ahmadi', 'ahmad.ahmadi2@email.com', '09199990018', 44,
        'EMAIL'),
       ('user7373', 'hashed_password_78', 'USER', 'Mahsa Rezaei', 'mahsa.rezaei2@email.com', '09112223351', 45,
        'PHONE_NUMBER'),
       ('user7474', 'hashed_password_79', 'USER', 'Kaveh Mohammadi', 'kaveh.mohammadi@email.com', '09125556684', 46,
        'EMAIL'),
       ('user7575', 'hashed_password_80', 'USER', 'Sima Karimzadeh', 'sima.karimzadeh2@email.com', '09138889907', 47,
        'PHONE_NUMBER'),
       ('user7676', 'hashed_password_81', 'USER', 'Behnam Hosseini', 'behnam.hosseini2@email.com', '09141112241', 48,
        'EMAIL'),
       ('user7777', 'hashed_password_82', 'USER', 'Parisa Ahmadi', 'parisa.ahmadi2@email.com', '09154445574', 1,
        'PHONE_NUMBER'),
       ('user7878', 'hashed_password_83', 'USER', 'Kamran Rezaei', 'kamran.rezaei2@email.com', '09167778897', 5,
        'EMAIL'),
       ('user7979', 'hashed_password_84', 'USER', 'Niloofar Mohammadi', 'niloofar.mohammadi2@email.com', '09170001130',
        6, 'PHONE_NUMBER'),
       ('user8080', 'hashed_password_85', 'USER', 'Arash Hosseini', 'arash.hosseini2@email.com', '09183334463', 7,
        'EMAIL'),
       ('user8181', 'hashed_password_86', 'USER', 'Shirin Karimzadeh', 'shirin.karimzadeh2@email.com', '09196667796', 8,
        'PHONE_NUMBER'),
       ('user8282', 'hashed_password_87', 'USER', 'Ali Ahmadi', 'ali.ahmadi2@email.com', '09199990019', 9, 'EMAIL'),
       ('user8383', 'hashed_password_88', 'USER', 'Leila Rezaei', 'leila.rezaei2@email.com', '09112223352', 10,
        'PHONE_NUMBER'),
       ('user8484', 'hashed_password_89', 'USER', 'Hassan Mohammadi', 'hassan.mohammadi2@email.com', '09125556685', 11,
        'EMAIL'),
       ('user8585', 'hashed_password_90', 'USER', 'Nazanin Hosseini', 'nazanin.hosseini2@email.com', '09138889908', 12,
        'PHONE_NUMBER'),
       ('user8686', 'hashed_password_91', 'USER', 'Amir Karimzadeh', 'amir.karimzadeh2@email.com', '09141112242', 13,
        'EMAIL'),
       ('user8787', 'hashed_password_92', 'USER', 'Fateme Ahmadi', 'fateme.ahmadi2@email.com', '09154445575', 14,
        'PHONE_NUMBER'),
       ('user8888', 'hashed_password_93', 'USER', 'Ahmad Rezaei', 'ahmad.rezaei2@email.com', '09167778898', 15,
        'EMAIL'),
       ('user8989', 'hashed_password_94', 'USER', 'Mahsa Hosseini', 'mahsa.hosseini3@email.com', '09170001131', 16,
        'PHONE_NUMBER'),
       ('user9090', 'hashed_password_95', 'USER', 'Kaveh Mohammadi', 'kaveh.mohammadi2@email.com', '09183334464', 17,
        'EMAIL'),
       ('user9191', 'hashed_password_96', 'USER', 'Sima Ahmadi', 'sima.ahmadi2@email.com', '09196667797', 18,
        'PHONE_NUMBER'),
       ('user9292', 'hashed_password_97', 'USER', 'Behnam Rezaei', 'behnam.rezaei2@email.com', '09199990020', 19,
        'EMAIL'),
       ('user9393', 'hashed_password_98', 'USER', 'Parisa Hosseini', 'parisa.hosseini3@email.com', '09112223353', 20,
        'PHONE_NUMBER'),
       ('user9494', 'hashed_password_99', 'USER', 'Kamran Karimzadeh', 'kamran.karimzadeh2@email.com', '09125556686',
        21, 'EMAIL'),
       ('user9595', 'hashed_password_100', 'USER', 'Niloofar Ahmadi', 'niloofar.ahmadi2@email.com', '09138889909', 22,
        'PHONE_NUMBER');
...
INSERT INTO flights (vehicle_id, airline_name, flight_class, number_of_stop, flight_code, origin_airport,
                     destination_airport, facility)
VALUES (1, 'Iran Air', 'Economy', 0, 'IR101', 'Mehrabad Airport', 'Mashhad Airport',
        '{"meals": "included", "wifi": false}'),
       (2, 'Mahan Air', 'Business', 1, 'MH102', 'Imam Khomeini Airport', 'Shiraz Airport',
        '{"meals": "included", "wifi": true, "extra_legroom": true}'),
       (3, 'Qeshm Air', 'Economy', 0, 'QS103', 'Mehrabad Airport', 'Tabriz Airport',
        '{"meals": "optional", "wifi": false}'),
       (4, 'Iran Air', 'Economy', 1, 'IR104', 'Imam Khomeini Airport', 'Ahvaz Airport',
        '{"meals": "included", "wifi": false}'),
       (5, 'Mahan Air', 'Business', 0, 'MH105', 'Mehrabad Airport', 'Kermanshah Airport',
        '{"meals": "included", "wifi": true}'),
       (6, 'Iran Aseman', 'Economy', 0, 'IA106', 'Mehrabad Airport', 'Rasht Airport',
        '{"meals": "optional", "wifi": false}'),
       (7, 'Zagros Airlines', 'Business', 1, 'ZG107', 'Imam Khomeini Airport', 'Bandar Abbas Airport',
        '{"meals": "included", "wifi": true}'),
       (8, 'Kish Air', 'Economy', 0, 'KI108', 'Mehrabad Airport', 'Yazd Airport',
        '{"meals": "optional", "wifi": false}'),
       (9, 'Iran Air', 'Economy', 1, 'IR109', 'Imam Khomeini Airport', 'Qom Airport',
        '{"meals": "included", "wifi": false}'),
       (10, 'Mahan Air', 'Business', 0, 'MH110', 'Mehrabad Airport', 'Kerman Airport',
        '{"meals": "included", "wifi": true}'),
       (11, 'Qeshm Air', 'Economy', 0, 'QS111', 'Mehrabad Airport', 'Zahedan Airport',
        '{"meals": "optional", "wifi": false}'),
       (12, 'Iran Air', 'Business', 1, 'IR112', 'Imam Khomeini Airport', 'Arak Airport',
        '{"meals": "included", "wifi": true}'),
       (13, 'Mahan Air', 'Economy', 0, 'MH113', 'Mehrabad Airport', 'Hamedan Airport',
        '{"meals": "optional", "wifi": false}'),
       (14, 'Zagros Airlines', 'Business', 1, 'ZG114', 'Imam Khomeini Airport', 'Gorgan Airport',
        '{"meals": "included", "wifi": true}'),
       (15, 'Kish Air', 'Economy', 0, 'KI115', 'Mehrabad Airport', 'Sanandaj Airport',
        '{"meals": "optional", "wifi": false}'),
       (16, 'Iran Aseman', 'Economy', 1, 'IA116', 'Imam Khomeini Airport', 'Tehran Airport',
        '{"meals": "included", "wifi": false}'),
       (17, 'Qeshm Air', 'Business', 0, 'QS117', 'Mehrabad Airport', 'Isfahan Airport',
        '{"meals": "included", "wifi": true}'),
       (18, 'Mahan Air', 'Economy', 1, 'MH118', 'Imam Khomeini Airport', 'Shiraz Airport',
        '{"meals": "optional", "wifi": false}'),
       (19, 'Iran Air', 'Business', 0, 'IR119', 'Mehrabad Airport', 'Mashhad Airport',
        '{"meals": "included", "wifi": true}'),
       (20, 'Zagros Airlines', 'Economy', 1, 'ZG120', 'Imam Khomeini Airport', 'Tabriz Airport',
        '{"meals": "optional", "wifi": false}'),
       (21, 'Iran Air', 'Economy', 0, 'IR121', 'Mehrabad Airport', 'Ahvaz Airport',
        '{"meals": "included", "wifi": false}'),
       (22, 'Mahan Air', 'Business', 1, 'MH122', 'Imam Khomeini Airport', 'Kermanshah Airport',
        '{"meals": "included", "wifi": true}'),
       (23, 'Qeshm Air', 'Economy', 0, 'QS123', 'Mehrabad Airport', 'Rasht Airport',
        '{"meals": "optional", "wifi": false}'),
       (24, 'Iran Aseman', 'Business', 1, 'IA124', 'Imam Khomeini Airport', 'Bandar Abbas Airport',
        '{"meals": "included", "wifi": true}'),
       (25, 'Kish Air', 'Economy', 0, 'KI125', 'Mehrabad Airport', 'Yazd Airport',
        '{"meals": "optional", "wifi": false}'),
       (26, 'Zagros Airlines', 'Economy', 1, 'ZG126', 'Imam Khomeini Airport', 'Qom Airport',
        '{"meals": "included", "wifi": false}'),
       (27, 'Iran Air', 'Business', 0, 'IR127', 'Mehrabad Airport', 'Kerman Airport',
        '{"meals": "included", "wifi": true}'),
       (28, 'Mahan Air', 'Economy', 1, 'MH128', 'Imam Khomeini Airport', 'Zahedan Airport',
        '{"meals": "optional", "wifi": false}'),
       (29, 'Qeshm Air', 'Business', 0, 'QS129', 'Mehrabad Airport', 'Arak Airport',
        '{"meals": "included", "wifi": true}'),
       (30, 'Iran Aseman', 'Economy', 1, 'IA130', 'Imam Khomeini Airport', 'Hamedan Airport',
        '{"meals": "included", "wifi": false}'),
       (31, 'Kish Air', 'Business', 0, 'KI131', 'Mehrabad Airport', 'Gorgan Airport',
        '{"meals": "included", "wifi": true}'),
       (32, 'Zagros Airlines', 'Economy', 1, 'ZG132', 'Imam Khomeini Airport', 'Sanandaj Airport',
        '{"meals": "optional", "wifi": false}'),
       (33, 'Iran Air', 'Business', 0, 'IR133', 'Mehrabad Airport', 'Qazvin Airport',
        '{"meals": "included", "wifi": true}'),
       (34, 'Mahan Air', 'Economy', 1, 'MH134', 'Imam Khomeini Airport', 'Urmia Airport',
        '{"meals": "optional", "wifi": false}'),
       (35, 'Qeshm Air', 'Business', 0, 'QS135', 'Mehrabad Airport', 'Zanjan Airport',
        '{"meals": "included", "wifi": true}'),
       (36, 'Iran Aseman', 'Economy', 1, 'IA136', 'Imam Khomeini Airport', 'Semnan Airport',
        '{"meals": "included", "wifi": false}'),
       (37, 'Kish Air', 'Business', 0, 'KI137', 'Mehrabad Airport', 'Bushehr Airport',
        '{"meals": "included", "wifi": true}'),
       (38, 'Zagros Airlines', 'Economy', 1, 'ZG138', 'Imam Khomeini Airport', 'Birjand Airport',
        '{"meals": "optional", "wifi": false}'),
       (39, 'Iran Air', 'Business', 0, 'IR139', 'Mehrabad Airport', 'Bojnurd Airport',
        '{"meals": "included", "wifi": true}'),
       (40, 'Mahan Air', 'Economy', 1, 'MH140', 'Imam Khomeini Airport', 'Sari Airport',
        '{"meals": "optional", "wifi": false}'),
       (41, 'Qeshm Air', 'Economy', 0, 'QS141', 'Mehrabad Airport', 'Amol Airport',
        '{"meals": "optional", "wifi": false}'),
       (42, 'Iran Aseman', 'Business', 1, 'IA142', 'Imam Khomeini Airport', 'Babol Airport',
        '{"meals": "included", "wifi": true}'),
       (43, 'Kish Air', 'Economy', 0, 'KI143', 'Mehrabad Airport', 'Gachsaran Airport',
        '{"meals": "optional", "wifi": false}'),
       (44, 'Zagros Airlines', 'Business', 1, 'ZG144', 'Imam Khomeini Airport', 'Ilam Airport',
        '{"meals": "included", "wifi": true}'),
       (45, 'Iran Air', 'Economy', 0, 'IR145', 'Mehrabad Airport', 'Khorramabad Airport',
        '{"meals": "included", "wifi": false}'),
       (46, 'Mahan Air', 'Business', 1, 'MH146', 'Imam Khomeini Airport', 'Ardabil Airport',
        '{"meals": "included", "wifi": true}'),
       (47, 'Qeshm Air', 'Economy', 0, 'QS147', 'Mehrabad Airport', 'Chabahar Airport',
        '{"meals": "optional", "wifi": false}'),
       (48, 'Iran Aseman', 'Business', 1, 'IA148', 'Imam Khomeini Airport', 'Dezful Airport',
        '{"meals": "included", "wifi": true}'),
       (49, 'Kish Air', 'Economy', 0, 'KI149', 'Mehrabad Airport', 'Borujerd Airport',
        '{"meals": "optional", "wifi": false}'),
       (50, 'Zagros Airlines', 'Business', 1, 'ZG150', 'Imam Khomeini Airport', 'Sabzevar Airport',
        '{"meals": "included", "wifi": true}');

-- افزودن قطارها (25 مورد - vehicle_id از 51 تا 75)
INSERT INTO trains (vehicle_id, train_stars, choosing_a_closed_coupe, facility)
VALUES (51, 4, true, '{"meals": "optional", "wifi": false, "power_outlets": true}'),
...
INSERT INTO buses (vehicle_id, company_name, bus_type, number_of_chairs, facility)
VALUES (76, 'Hamsafar', 'VIP', 30, '{"air_conditioning": true, "snacks": true}'),
...
INSERT INTO tickets (vehicle_id, origin_location_id, destination_location_id, departure_start, departure_end, price,
...
(80, 5, 1, '2025-05-25 07:30:00', '2025-05-25 12:30:00', 600000, 5, 0);
-- Isfahan to Tehran

-- افزودن رزروها (100 رزرو)
INSERT INTO reservations (username, ticket_id, reservation_status, date_and_time_of_reservation, reservation_seat)
VALUES
...
-- گزارش‌های نوع TRAVEL_DELAY
    ('zahra101', 4, 'TRAVEL_DELAY', 'پرواز تأخیر داشته و به موقع حرکت نکرد.'), ('reza202', 5, 'TRAVEL_DELAY', 'قطار با تأخیر 2 ساعته رسید.'), ('leila303', 6, 'TRAVEL_DELAY', 'اتوبوس هنوز به مقصد نرسیده است.'),
-- گزارش‌های نوع CANCEL
    ('hassan404', 7, 'CANCEL', 'می‌خواهم رزرو را لغو کنم، لطفاً کمک کنید.'), ('nazanin505', 8, 'CANCEL', 'رزرو به اشتباه ثبت شده، نیاز به لغو دارم.'), ('amir606', 9, 'CANCEL', 'تاریخ سفر اشتباه است، درخواست لغو دارم.'),
-- گزارش‌های نوع OTHER
    ('fateme707', 10, 'OTHER', 'اطلاعات صندلی برایم ارسال نشده است.'), ('ahmad808', 11, 'OTHER', 'نیاز به اطلاعات بیشتر درباره مسیر دارم.'), ('mahsa909', 12, 'OTHER', 'مشکل در دسترسی به بلیط الکترونیکی.'),
-- گزارش‌های نوع PAYMENT
    ('kaveh1010', 13, 'PAYMENT', 'پرداخت با کارت اعتباری انجام نشد.'), ('sima1111', 14, 'PAYMENT', 'مبلغ اضافی از حسابم کسر شده است.'), ('behnam1212', 15, 'PAYMENT', 'درخواست بازپرداخت دارم.'),
-- گزارش‌های نوع TRAVEL_DELAY
    ('parisa1313', 16, 'TRAVEL_DELAY', 'پرواز 3 ساعت تأخیر داشت.'), ('kamran1414', 17, 'TRAVEL_DELAY', 'قطار با تأخیر به ایستگاه رسید.'), ('niloofar1515', 18, 'TRAVEL_DELAY', 'اتوبوس طبق برنامه حرکت نکرد.'),
-- گزارش‌های نوع CANCEL
    ('arash1616', 19, 'CANCEL', 'نیاز به لغو فوری رزرو دارم.'), ('shirin1717', 20, 'CANCEL', 'رزرو را به اشتباه انجام داده‌ام.'), ('user1818', 21, 'CANCEL', 'تاریخ سفر تغییر کرده، درخواست لغو.'),
-- گزارش‌های نوع OTHER
    ('user1919', 22, 'OTHER', 'شماره بلیط برایم ارسال نشده است.'), ('user2020', 23, 'OTHER', 'نیاز به پشتیبانی برای تغییر صندلی دارم.'), ('user2121', 24, 'OTHER', 'لینک بلیط کار نمی‌کند.'),
-- گزارش‌های نوع PAYMENT
    ('user2222', 25, 'PAYMENT', 'پرداخت با کیف پول مشکل دارد.'), ('user2323', 26, 'PAYMENT', 'تراکنش ناموفق بود، اما رزرو فعال است.'), ('user2424', 27, 'PAYMENT', 'درخواست بررسی تراکنش.'),
-- گزارش‌های نوع TRAVEL_DELAY
    ('user2525', 28, 'TRAVEL_DELAY', 'پرواز با تأخیر 4 ساعته مواجه شد.'), ('user2626', 29, 'TRAVEL_DELAY', 'قطار هنوز به مقصد نرسیده است.'), ('user2727', 30, 'TRAVEL_DELAY', 'اتوبوس با تأخیر حرکت کرد.'),
-- گزارش‌های نوع CANCEL
    ('user2828', 31, 'CANCEL', 'نیاز به لغو رزرو به دلیل تغییر برنامه.'), ('user2929', 32, 'CANCEL', 'رزرو را به اشتباه ثبت کرده‌ام.');

-- new data
INSERT INTO users (username, password, user_role, name, email, phone_number, city, authentication_method)
VALUES ('mehdi2121', 'hashed_password_101', 'USER', 'Mehdi Shariati', 'mehdi.shariati@email.com', '09201112233', 2,
        'EMAIL'),
       ('narges2222', 'hashed_password_102', 'USER', 'Narges Bahrami', 'narges.bahrami@email.com', '09214445566', 3,
        'PHONE_NUMBER'),
       ('yasin2323', 'hashed_password_103', 'USER', 'Yasin Ghaffari', 'yasin.ghaffari@email.com', '09227778899', 4,
        'EMAIL'),
       ('sanaz2424', 'hashed_password_104', 'USER', 'Sanaz Mousavi', 'sanaz.mousavi@email.com', '09230001122', 5,
        'PHONE_NUMBER'),
       ('omid2525', 'hashed_password_105', 'USER', 'Omid Shokri', 'omid.shokri@email.com', '09243334455', 6, 'EMAIL'),
       ('bahar2626', 'hashed_password_106', 'USER', 'Bahar Azizi', 'bahar.azizi@email.com', '09256667788', 7,
        'PHONE_NUMBER'),
       ('kianoush2727', 'hashed_password_107', 'USER', 'Kianoush Farhadi', 'kianoush.farhadi@email.com', '09269990011',
        8, 'EMAIL'),
       ('elnaz2828', 'hashed_password_108', 'USER', 'Elnaz Gholami', 'elnaz.gholami@email.com', '09272223344', 9,
        'PHONE_NUMBER'),
       ('pouya2929', 'hashed_password_109', 'USER', 'Pouya Khosravi', 'pouya.khosravi@email.com', '09285556677', 10,
        'EMAIL'),
       ('setareh3030', 'hashed_password_110', 'USER', 'Setareh Esmaili', 'setareh.esmaili@email.com', '09298889900', 11,
        'PHONE_NUMBER'),
       ('shayan3131', 'hashed_password_111', 'USER', 'Shayan Rahmani', 'shayan.rahmani@email.com', '09301112234', 12,
        'EMAIL'),
       ('hanieh3232', 'hashed_password_112', 'USER', 'Hanieh Shariati', 'hanieh.shariati@email.com', '09314445567', 13,
        'PHONE_NUMBER'),
       ('babak3333', 'hashed_password_113', 'USER', 'Babak Ghaffari', 'babak.ghaffari@email.com', '09327778890', 14,
        'EMAIL'),
       ('golnaz3434', 'hashed_password_114', 'USER', 'Golnaz Mousavi', 'golnaz.mousavi@email.com', '09330001123', 15,
        'PHONE_NUMBER'),
       ('farhad3535', 'hashed_password_115', 'USER', 'Farhad Shokri', 'farhad.shokri@email.com', '09343334456', 16,
        'EMAIL'),
       ('mahtab3636', 'hashed_password_116', 'USER', 'Mahtab Azizi', 'mahtab.azizi@email.com', '09356667789', 17,
        'PHONE_NUMBER'),
       ('rostam3737', 'hashed_password_117', 'USER', 'Rostam Farhadi', 'rostam.farhadi@email.com', '09369990012', 18,
        'EMAIL'),
       ('taraneh3838', 'hashed_password_118', 'USER', 'Taraneh Gholami', 'taraneh.gholami@email.com', '09372223345', 19,
        'PHONE_NUMBER'),
       ('khashayar3939', 'hashed_password_119', 'USER', 'Khashayar Khosravi', 'khashayar.khosravi@email.com',
        '09385556678', 20, 'EMAIL'),
       ('parvaneh4040', 'hashed_password_120', 'USER', 'Parvaneh Esmaili', 'parvaneh.esmaili@email.com', '09398889901',
        21, 'PHONE_NUMBER');

INSERT INTO tickets (vehicle_id, origin_location_id, destination_location_id, departure_start, departure_end, price,
                     total_capacity, remaining_capacity)
VALUES (76, 1, 12, '2025-04-10 08:30:00', '2025-04-10 14:00:00', 3000000, 10, 3);

INSERT INTO reservations (username, ticket_id, reservation_status, date_and_time_of_reservation, reservation_seat)
VALUES ('mehdi2121', 21, 'RESERVED', '2025-4-8 10:00:00', 1),
...
insert into requests (username, reservation_id, request_subject, request_text, is_checked, is_accepted, check_by)
values ('mehdi2121', 101, 'CANCEL', 'test', TRUE, FALSE, 'admin1'),
